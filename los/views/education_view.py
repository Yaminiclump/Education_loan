...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={"customer": openapi.Schema(
            type=openapi.TYPE_OBJECT,
            required=["customer_id", "institute_id", "course_id", "stream_id", "end_month_year", "marks", "max_marks", "marks_type", "course_type"],
            properties={"customer_id": openapi.Schema(type=openapi.TYPE_INTEGER, description="customer id"),
                        "educations": openapi.Items(
                            ...
                            items=openapi.Items(
                                ...
                                properties={
                                    "institute_id": openapi.Schema(type=openapi.TYPE_INTEGER, description="institute id"),
                                    "institute_name": openapi.Schema(type=openapi.TYPE_STRING, description="institute name"),
                                    ...
                                    "stream_id": openapi.Schema(type=openapi.TYPE_INTEGER, description="stream id"),
                                    "stream_name": openapi.Schema(type=openapi.TYPE_STRING, description="stream name"),
                                    "start_month_year": openapi.Schema(type=openapi.TYPE_STRING, description="In yyyy-mm"),
                                    "end_month_year": openapi.Schema(type=openapi.TYPE_STRING, description="In yyyy-mm"),
                                    "marks": openapi.Schema(type=openapi.TYPE_INTEGER, description="marks or cgpa obtained"),
                                    "max_marks": openapi.Schema(type=openapi.TYPE_INTEGER, description="max marks"),
                                    "marks_type": openapi.Schema(type=openapi.TYPE_STRING, description="percentage/cgpa/percentile"),
                                    "duration_months": openapi.Schema(type=openapi.TYPE_INTEGER, description="duration"),
                                    "course_type": openapi.Schema(type=openapi.TYPE_STRING, description="full_time/part_time"),
            ...
            properties={"customer_id": openapi.Schema(type=openapi.TYPE_INTEGER, description="customer id"),
                        "educations": openapi.Items(
                            ...
                            items=openapi.Items(
                                type=openapi.TYPE_OBJECT,
                                properties={
                                    "education_id": openapi.Schema(type=openapi.TYPE_INTEGER, description="education id"),
                                    ...
                                    "marks_type": openapi.Schema(type=openapi.TYPE_STRING, description="percentage/cgpa"),
                                    "duration_months": openapi.Schema(type=openapi.TYPE_INTEGER, description="duration"),
                                    "course_type": openapi.Schema(type=openapi.TYPE_STRING, description="full_time/part_time"),
                                }),
                            description="define all the variable, put their name and values"),
