...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={"customer": openapi.Schema(
            ...
            required=["first_name"],
            properties={
                "salutation": openapi.Schema(type=openapi.TYPE_INTEGER, description="mr:1, mrs:2, dr:3 undefined:0"),
                "first_name": openapi.Schema(type=openapi.TYPE_STRING, description="first name"),
                "middle_name": openapi.Schema(type=openapi.TYPE_STRING, description="middle name"),
                "last_name": openapi.Schema(type=openapi.TYPE_STRING, description="last name"),
                "gender": openapi.Schema(type=openapi.TYPE_INTEGER, description="male:1, female:2, trans:3, will_hide:0"),
                ...
                "marital_status": openapi.Schema(type=openapi.TYPE_INTEGER, description="married:1, single:2,separated:3, will_hide:0"),
