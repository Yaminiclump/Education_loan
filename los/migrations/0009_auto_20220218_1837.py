# Generated by Django 3.2.8 on 2022-02-18 18:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('los', '0008_employment_employmentlog'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='education',
            name='customer',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.RESTRICT, to='los.customer'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='education',
            name='marks',
            field=models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(10), django.core.validators.MaxValueValidator(10000)]),
        ),
