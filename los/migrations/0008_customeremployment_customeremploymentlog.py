# Generated by Django 3.2.8 on 2022-02-15 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_by', models.TextField()),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='los.customer')),
                ('customeremployment', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='los.customeremployment')),
            ],
            options={
